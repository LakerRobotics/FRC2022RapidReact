...
*/
	public double getMeasurment() {
		...
		SmartDashboard.putNumber("MotionControlHelper.adjustTargetSpeed targetSpeed", getTargetAngle(m_source.getAsDouble()/*currentMeasuredDistance*/));
...
//	    private AdjustSpeedAsTravelHelper m_MCHelper;
	    ...
	    public wrapPIDInput(AdjustAngleAsTravelHelper motionControlHelper, DoubleSupplier /*PIDSource*/ source, DoubleSupplier sourceRate) {
