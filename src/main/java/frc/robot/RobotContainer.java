...
private final XboxController driverController = new XboxController(1);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutonomousCommand", new AutonomousCommand(m_shooter,m_conveyor));
...
m_chooser.setDefaultOption("AutnomouseCommand",new AutonomousCommand(m_shooter,m_conveyor));
