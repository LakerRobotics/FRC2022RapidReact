...
private final XboxController driverController = new XboxController(1);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutonomousCommand", new AutonomousShootandBackup(m_intake,m_shooter,m_conveyor,m_driveTrain));
...
/*
m_chooser.setDefaultOption("AutnomouseStraight",new AutonomousWithDriveStraight(m_intake, m_shooter, m_conveyor, m_driveTrain,
...
shooterMovePowerLong.whileHeld(new ShooterMoveHigh( m_shooter ) ,true);
    SmartDashboard.putData("ShooterMovePowerLong",new ShooterMove( m_shooter ) );
