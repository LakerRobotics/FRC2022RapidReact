 ...
 *
 */
public class AutonomousShootandBackupStraight extends SequentialCommandGroup {
        public AutonomousShootandBackupStraight(Intake theIntake, Shooter shooter,Conveyor theConveyor, DriveTrain theDriveTrain){
...
CommandGroupBase spinAndShootAndintake = SequentialCommandGroup.parallel(new ShooterMoveLow(shooter),
 ...
 //       addCommands(new ShooterMoveLow(shooter));
      ...
      // addCommands(new IntakeDeployTimed(theIntake, theConveyor));
       ...
       addCommands(new DriveTrainMoveStraight(theDriveTrain, 100, 0.5, 200, 0));  
